...
<div class="profile_details_div">
            <p>Gender</p>
            <p class="p_profile">${user.gender}</p>
          </div>
          <hr
            class="hr_black"
            width="100%"
        ...
        "
          /><div class="profile_details_div">
            <p>Height</p>
            <p class="p_profile">${user.height} cm</p>
          </div>
          <hr
            class="hr_black"
            width="100%"
        ...
        "
          /><div class="profile_details_div">
            <p>Jobtitle</p>
            <p class="p_profile">${user.company.title}</p>
          </div>
          <hr
            class="hr_black"
            width="100%"
        ...
        "
          /><div class="profile_details_div">
            <p>Hair</p>
            <p class="p_profile">${user.hair.color}, ${user.hair.type}</p>
          </div>
          <hr
            class="hr_black"
            width="100%"
